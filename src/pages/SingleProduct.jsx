...
const SingleProduct = () => {
  ...
  const OriginalPrice = SingleProduct
    ? Math.round(SingleProduct.price + (SingleProduct.price * (SingleProduct.discount || 10) / 100))
    : 0;
    ...
    <>
      {SingleProduct ? (
        <div className="px-4 pb-4 md:px-0">
          ...
          <div className="max-w-3xl mx-auto md:p-6 grid grid-cols-1 md:grid-cols-2 gap-15">
            {/* product image */}
            ...
            <div className="flex flex-col gap-6">
              ...
              <p className="text-xl text-red-500 font-bold">
                ...
                <span className="bg-red-500 text-white px-4 py-2 rounded-full">
                  {SingleProduct.discount || 10}% discount
                </span>
              </p>
